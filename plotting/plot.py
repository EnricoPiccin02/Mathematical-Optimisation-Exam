...
def plot_matheuristic(df_mh, df_opt, set_instance_name):
    df_mh = df_mh.copy()
    df_opt = df_opt.copy()
...
if __name__ == "__main__":
    ...
    plot_matheuristic(rnd_df[rnd_df["method"] == "Matheuristic"], rnd_df[rnd_df["method"] == "MILP"], "RAND") # Plot for Matheuristic (RAND)
    ...
    plot_matheuristic(swn_df[swn_df["method"] == "Matheuristic"], swn_df[swn_df["method"] == "MILP"], "SWN") # Plot for Matheuristic (SWN)